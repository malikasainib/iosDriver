...
class SideMenuViewController: UIViewController {
    ...
    var count = 0
    //MARK:- Variables
    var sideMenuNameArr = ["Home","Set Destination","Documents","Pending Rides","Accepted Rides","Completed Rides","Cancelled Rides","My Earnings","Profile","Help","Bank Detail","Privacy Policy","About Us","Delete Account","Logout"]
